	 ...
	 */
	 ...
	 function init()
	 {
		 $(".btn-toggle-search").click(function () {
			 if($(".btn-toggle-search .icon-large").hasClass("icon-plus"))
				 $(".btn-toggle-search .icon-plus").removeClass("icon-plus").addClass("icon-minus");
			 else
				 $(".btn-toggle-search .icon-minus").removeClass("icon-minus").addClass("icon-plus");
